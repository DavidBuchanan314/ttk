...
#define SDL_GFXPRIMITIVES_MICRO	12
...
/* Horizontal line */
    ...
    DLLINTERFACE int hlineByte(SDL_Surface * dst, Sint16 x1, Sint16 x2, Sint16 y, Uint32 color);
...
/* Vertical line */
    ...
    DLLINTERFACE int vlineByte(SDL_Surface * dst, Sint16 x1, Sint16 x2, Sint16 y, Uint32 color);
...
/* Rectangle */
    ...
    DLLINTERFACE int rectangleByte(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color);
...
/* Filled rectangle (Box) */
    ...
    DLLINTERFACE int boxByte(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color);
...
/* Line */
    ...
    DLLINTERFACE int lineByte(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color);
...
/* AA Line */
    ...
    DLLINTERFACE int aalineByte(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color);
...
/* Circle */
    ...
    DLLINTERFACE int circleByte(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 r, Uint32 color);
...
/* AA Circle */
    ...
    DLLINTERFACE int aacircleByte(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 r, Uint32 color);
...
/* Filled Circle */
    ...
    DLLINTERFACE int filledCircleByte(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 r, Uint32 color);
...
/* Ellipse */
    ...
    DLLINTERFACE int ellipseByte(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color);
...
/* AA Ellipse */
    ...
    DLLINTERFACE int aaellipseByte(SDL_Surface * dst, Sint16 xc, Sint16 yc, Sint16 rx, Sint16 ry, Uint32 color);
...
/* Filled Ellipse */
    ...
    DLLINTERFACE int filledEllipseByte(SDL_Surface * dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color);
...
/* Trigon */
    ...
    DLLINTERFACE int trigonByte(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Uint32 color);
...
/* AA-Trigon */
    ...
    DLLINTERFACE int aatrigonByte(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Uint32 color);
...
/* Filled Trigon */
    ...
    DLLINTERFACE int filledTrigonByte(SDL_Surface * dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Uint32 color);
...
/* Polygon */
    ...
    DLLINTERFACE int polygonByte(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color);
...
/* AA-Polygon */
    ...
    DLLINTERFACE int aapolygonByte(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color);
...
/* Filled Polygon */
    ...
    DLLINTERFACE int filledPolygonByte(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color);
